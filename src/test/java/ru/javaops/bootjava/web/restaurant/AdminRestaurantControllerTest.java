...
public class AdminRestaurantControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        perform(MockMvcRequestBuilders.delete(REST_URL_SLASH + FIRST_RESTAURANT_ID))
                .andDo(print())
                .andExpect(status().isNoContent());
        assertFalse(restaurantRepository.findById(FIRST_RESTAURANT_ID).isPresent());
    }
    ...
    void update() throws Exception {
        ...
        updated.setId(null);
        perform(MockMvcRequestBuilders.put(REST_URL_SLASH + FIRST_RESTAURANT_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .content(writeValue(updated)))
                .andDo(print())
                .andExpect(status().isNoContent());

        RESTAURANT_MATCHER.assertMatch(restaurantRepository.getExisted(FIRST_RESTAURANT_ID), getUpdated());
    }
