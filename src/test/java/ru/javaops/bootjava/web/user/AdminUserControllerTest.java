...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void get() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + SLASH + ADMIN_ID))
    ...
    void getNotFound() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL + SLASH + NOT_FOUND))
                .andDo(print())
    ...
    void delete() throws Exception {
        perform(MockMvcRequestBuilders.delete(REST_URL + SLASH + USER_ID))
                .andDo(print())
    ...
    void deleteNotFound() throws Exception {
        perform(MockMvcRequestBuilders.delete(REST_URL + SLASH + NOT_FOUND))
                .andDo(print())
    ...
    void enableNotFound() throws Exception {
        perform(MockMvcRequestBuilders.patch(REST_URL + SLASH + NOT_FOUND)
                .param("enabled", "false")
    ...
    void update() throws Exception {
        ...
        updated.setId(null);
        perform(MockMvcRequestBuilders.put(REST_URL + SLASH + USER_ID)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void enable() throws Exception {
        perform(MockMvcRequestBuilders.patch(REST_URL + SLASH + USER_ID)
                .param("enabled", "false")
                .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(status().isNoContent());

        assertFalse(userRepository.getReferenceById(USER_ID).isEnabled());
    }
